...
/**
 * <P>Pipe Fitting Interface.</P>
 *
 * <P>An <code>IPipeFitting</code> can be connected to other
...
public interface IPipeFitting {
    ...
    /**
     * <P>Connect another Pipe Fitting to the output.</P>
     *
     ...
     *
     * @param output pipe to connect
     * @return true if no other fitting was already connected.
     */
    boolean connect(IPipeFitting output);
    ...
    /**
     * <P>Write the message to the output Pipe Fitting.</P>
     *
     ...
     * @return true if message was successfuly written
     */
    boolean write(IPipeMessage message);
}
